        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExternalServices_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeTriggers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeTriggers_ExternalServices_ExternalServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeInvocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeInvocations_RecipeActions_RecipeActionId",
                        column: x => x.RecipeActionId,
                        principalTable: "RecipeActions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecipeInvocations_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalServices_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeInvocations_RecipeId",
                table: "RecipeInvocations",
                column: "RecipeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeTriggers_ExternalServiceId",
                table: "RecipeTriggers",
                column: "ExternalServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeTriggers_RecipeId",
                table: "RecipeTriggers",
                column: "RecipeId",
                unique: true);
        }
