...
namespace BtcTransmuter.Tests
{
    public class ActionDispatcherTests
    {
        ...
        public async Task ActionDispatcher_Dispatch_NothingToExecute()
        {
            ...
            await actionDispatcher.Dispatch(new { }, new RecipeAction());
            ...
            handler.Setup(actionHandler => actionHandler.Execute(It.IsAny<object>(), It.IsAny<RecipeAction>()))
                .ReturnsAsync(
        ...
        public async Task ActionDispatcher_Dispatch_ExecuteAndLogMultipleHandlers()
        {
            ...
            handler2.Setup(actionHandler => actionHandler.Execute(It.IsAny<object>(), It.IsAny<RecipeAction>()))
                .ReturnsAsync(
                    () => new ActionHandlerResult()
                    { 
                        Executed = true,
