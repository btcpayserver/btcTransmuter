...
namespace BtcTransmuter.Extension.NBXplorer.Actions.NBXplorerCreatePSBT
{
        ...
        NBXplorerCreatePSBTData>
    {
        ...
        public NBXplorerCreatePSBTController(IMemoryCache memoryCache,
        ...
        protected override async Task<NBXplorerCreatePSBTViewModel> BuildViewModel(RecipeAction from)
        {
            var fromData = from.Get<NBXplorerCreatePSBTData>();
            var services = await _externalServiceManager.GetExternalServicesData(new ExternalServicesDataQuery()
            {
                Type = new[] {NBXplorerWalletService.NBXplorerWalletServiceType},
                UserId = GetUserId()
            });
            return new NBXplorerCreatePSBTViewModel
            {
        ...
        protected override async Task<(RecipeAction ToSave, NBXplorerCreatePSBTViewModel showViewModel)> BuildModel(
            NBXplorerCreatePSBTViewModel viewModel, RecipeAction mainModel)
        {
            var services = await _externalServiceManager.GetExternalServicesData(new ExternalServicesDataQuery()
            {
                Type = new[] {NBXplorerWalletService.NBXplorerWalletServiceType},
            ...
            {
                viewModel.Outputs.Add(new NBXplorerCreatePSBTData.TransactionOutput());
            ...
            if (ModelState.IsValid)
            {
                ...
                mainModel.Set<NBXplorerCreatePSBTData>(viewModel);
        ...
        public class NBXplorerCreatePSBTViewModel : NBXplorerCreatePSBTData, IActionViewModel, IUseExternalService
        {
